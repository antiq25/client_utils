...
export const authAPI: IAuthAPI = {
    ...
    updateProfile: (id: number, data: Partial<ISignup>) =>
        apiCall('updateProfile', () => apiClient.put(`${authAPIEndpoints.updateProfile}/${id}`, data), 'Profile updated', 'Updating profile failed'),
    ...
    getProfile: (id: number) =>
        apiCall('fetchProfile', () => apiClient.get(`${authAPIEndpoints.fetchProfile}/${id}`), 'Profile fetched', 'Fetching profile failed'),
